...
export const FormDespacho = ({ herramienta, onClose }) => {
  ...
  const onSubmit = async (data) => {
    ...
    const jsonData = {
      id: herramienta.id,
      marca_producto: herramienta.marca_producto,
      codigo_marca: herramienta.codigo_marca,
      nombre_producto: herramienta.nombre_producto,
      valor_producto: herramienta.valor_producto,
    };
    ...
    try {
      await axios.put(
        `http://3.221.189.4:8000/ventas/${venta.id}/`,
        jsonDataSales,
        {
          headers: {
      ...
      await axios.post("http://3.221.189.4:8000/despachos/", jsonData, {
        headers: {
          "Content-Type": "application/json",
        },
      });
